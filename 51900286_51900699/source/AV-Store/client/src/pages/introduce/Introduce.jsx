            ...
            <div className="container">
                ...
                <ul className="introduce-list">
                    <li className="introduce-item">
                        <div className="row">
                            <div className="col-12 col-md-6 d-flex justify-content-center">
                                <img className="introduce-item__img" src="http://localhost:5000/images/introduce1.jpg" alt="" />
                            </div>
                    ...
                    <li className="introduce-item">
                        <div className="row">
                            <div className="col-12 col-md-6 d-md-none d-flex justify-content-center">
                                <img className="introduce-item__img" src="http://localhost:5000/images/introduce2.jpg" alt="" />
                            </div>
                            <div className="col-12 col-md-6">
                                <div className="introduce-item__content">
                                    <div className="introduce-item__wrapper">
                    ...
                    <li className="introduce-item">
                        <div className="row">
                            <div className="col-12 col-md-6 d-flex justify-content-center">
                                <img className="introduce-item__img" src="http://localhost:5000/images/introduce3.jpg" alt="" />
                            </div>
                            <div className="col-12 col-md-6">
                                <div className="introduce-item__content">
                                    <div className="introduce-item__wrapper">
                    ...
                    <li className="introduce-item">
                        <div className="row">
                            <div className="col-12 d-md-none d-flex justify-content-center">
                                <img className="introduce-item__img" src="http://localhost:5000/images/introduce4.jpg" alt="" />
                            </div>
                            <div className="col-12 col-md-6">
                                <div className="introduce-item__content">
                                    <div className="introduce-item__wrapper">
                ...
                <div className="introduce-founder">
                    ...
                    <ul className="introduce-founder__list">
                        <li className="introduce-founder__item">
                            <img className="introduce-founder__img" src="http://localhost:5000/images/founder1.jpg" alt="" />
                        ...
                        <li className="introduce-founder__item">
                            <img className="introduce-founder__img" src="http://localhost:5000/images/founder2.jpg" alt="" />
                            <div className="introduce-founder__info">
