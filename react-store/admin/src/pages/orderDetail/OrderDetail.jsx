                        ...
                        <div className="col-12 col-xl-7">
                            ...
                            <div className="order-detail__products">
                                <div className="order-detail__product">
                                    <div className="order-detail__product-left">
                                        <img className="order-detail__product-img" src="/images/products/ao1.jpg" alt="" />
                                        <div className="order-detail__product-info">
                                            <h5 className="order-detail__product-name">Áo vest K98</h5>
                                            <span className="order-detail__product-quantity"><b>Số lượng:</b> 1</span>
                                            <span className="order-detail__product-size"><b>Kích thước:</b> XL</span>
                                            <span className="order-detail__product-color"><b>Màu sắc:</b> Đen</span>
                                        </div>
                                    </div>
                                    <div className="order-detail__product-right">
                                        12.000.000đ
                                    </div>
                                </div>
                                <div className="order-detail__product">
