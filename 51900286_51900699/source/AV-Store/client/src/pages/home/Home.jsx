                    ...
                    <div className="col-12 col-lg-9">
                        <div className="home-container">
                            <div className="home-title">
                                ...
                                <a href="/collections">Xem chi tiết</a>
                            </div>
                            <div className="container-fluid home-list">
                                <div className="row">
                                    <div className="col-12 col-md-6 col-lg-3">
                                        <div className="home-item">
                                            <img src="http://localhost:5000/images/home2.jpg" alt="Áo" />
                                            <span>Áo</span>
                                        </div>
                                    </div>
                                    <div className="col-12 col-md-6 col-lg-3">
                                        <div className="home-item">
                                            <img src="http://localhost:5000/images/home3.jpg" alt="Quần" />
                                            <span>Quần</span>
                                        </div>
                                    </div>
                                    <div className="col-12 col-md-6 col-lg-3">
                                        <div className="home-item">
                                            <img src="http://localhost:5000/images/home4.jpg" alt="Giày" />
                                            <span>Giày</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-12 col-md-6 col-lg-3">
                                        <div className="home-item">
                                            <img src="http://localhost:5000/images/home5.jpg" alt="Phụ kiện" />
                                            <span>Phụ kiện</span>
                                        </div>
                                    </div>
                                </div>
